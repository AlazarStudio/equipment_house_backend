...
const transporter = nodemailer.createTransport({
  service: 'mail', // Используем Gmail (или любой другой почтовый сервис)
  auth: {
    user: 'adamej10@bk.ru', // Ваш email (из переменных окружения)
    pass: 'Gadam-1997', // Ваш пароль (или пароль для приложения)
  },
});
