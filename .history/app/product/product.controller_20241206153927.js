...
export const updateProduct = asyncHandler(async (req, res) => {
  ...
  // Обработка характеристик, если они передаются
  const characteristicsUpdate = characteristics
    ? {
        update: characteristics.map((characteristic) => ({
          // Пример структуры: обновление характеристик
          id: characteristic.id, // Для обновления по ID
  ...
  const updateData = {
    ...
    // Добавляем характеристику только если она есть
